...
public interface BaseDeDatosEscenarios {
    ...
    String DB_ATRIB_XAVIER = "Xavier School for Gifted Youngsters13";
    String DB_ATRIB_COINS = "Monedas";
    String DB_ATRIB_MEMBERS = "Miembros";
    String DB_ATRIB_MOVEMENTS = "Movimientos";
    String DB_ATRIB_ENERGY = "Energia vital";
}
